...
public class Vendor {
    ...
    public List<VendorRating> getRatings() { return ratings; }
    public void setRatings(List<VendorRating> ratings) { this.ratings = ratings; }

    public Object getPhone() { return contactNumber; }
    public void setPhone(Object phone) { this.contactNumber = (String) phone; }
}